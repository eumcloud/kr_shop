<?
    ...
    /* ============================================================================== */
    if("T0000" == $row_setup[P_ID]) { $g_conf_js_url    = "http://pay.kcp.co.kr/plugin/payplus_test_un.js"; }
    else { $g_conf_js_url    = "http://pay.kcp.co.kr/plugin/payplus_un.js"; }

	if("T0000" == $row_setup[P_ID]) { $g_conf_gw_url = "testpaygw.kcp.co.kr"; }
	...
	if("T0000" == $row_setup[P_ID]) { $g_wsdl = $g_conf_home_dir."/common/KCPPaymentService.wsdl"; }
	else { 
		//$g_wsdl = $g_conf_home_dir."/common/real_KCPPaymentService.wsdl"; 
		$g_wsdl = $_SERVER[DOCUMENT_ROOT]."/m/shop.order.result_kcp.wsdl"; 
	}
