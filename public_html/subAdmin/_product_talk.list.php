...
?>
				...
				<div class="content_section_inner">
					...
					<table class="list_TB" summary="리스트기본">
						<colgroup>
							<col width="50px"/><col width="100px"/><col width="130px"/><col width="70px"/><col width="*"/><col width="80px;"/><col width="140px;"/>
						</colgroup>
						<thead>
							<tr>
...
<?PHP
	...
	$que = "select
		tt.*, p.name as p_name, p.prolist_img, p.prolist_img2,
