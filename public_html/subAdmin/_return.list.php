<?PHP
	...
	$pass_status = $pass_status ? $pass_status : "P";
	...
	$s_query .= " and op.op_partnerCode = '".$com[id]."' and rr_status in ('P','Y') ";
							...
							<tr>
								...
								<td class="conts">
									<select name="pass_status">
										<option value="">- 선택 -</option>
										<option value="P" <?="P"==$pass_status?'selected':''?>>처리중</option>
										<option value="Y" <?="Y"==$pass_status?'selected':''?>>완료</option>
									</select>
								</td>
							</tr>
						</tbody>
