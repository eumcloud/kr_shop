...
<? } else { ?>
	<ul>
		...
		?>
			...
			<!-- 공지사항 체크 -->
			<li class="notice">
				<a href="#none" onclick="<?=$onclick_event?>;return false;" class="upper_link"></a>
			...
			<li>
				...
				<? if($is_file) { ?><!--<span class="icon_front"><img src="/m/images/cm_images/board_ic_file.png" alt="파일첨부" /></span>--><? } ?>
