    ...
    function app_width(){
        ...
        if( app_width_num >= 640 ) {
            ...
            app_global_height = 330;
            app_global_height2 = app_global_height/2.3;    // 비율
        }
        else {
            app_global_width = app_width_num;
            app_global_height = app_global_width*(330/640);
            app_global_height2 = app_global_height/2.3;    // 비율
        }
        ...
        $('#imgs_grip1 .middle_banner').css({'width':app_global_width+'px' , 'height':app_global_height2+'px'});// imgs_head 지정
        $('#imgs_grip1 .middle_banner > img').css({'width':(app_global_width/2)+'px' , 'height':(app_global_height2)+'px'});// imgs_head 지정
