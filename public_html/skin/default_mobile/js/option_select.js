    ...
    function option_select_update(_type , uid,code) {
        ...
        $.ajax({
            url: "/m/option_select_update.php",
            cache: false,
            type: "POST",
	...
	function add_option_select_add(code , uid) {
		if( uid ) {
			$.ajax({
				url: "/m/add_option_select_add.php",
				cache: false,
				type: "POST",
				data: {"code" : code , "uid" : uid },
				success: function(data){
	...
	function add_option_select_update(_type , uid,code) {
		$.ajax({
			url: "/m/add_option_select_update.php",
			cache: false,
			type: "POST",
