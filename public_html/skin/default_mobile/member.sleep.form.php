...
$msr = _MQ("select * from odtMemberSleep where id='". $_id ."' "); // 맴버 sleep 테이블 
...
<form name="login_frm" id="login_frm" method="post" action="/m/member.sleep.pro.php" target="common_frame">
