...
<?
    ...
    { 
        $ool_type = 'I';
        $r = _MQ("select ool_amount_total, ool_deposit_tel, ool_bank_owner from odtOrderOnlinelog where ool_ordernum='$order_no' order by ool_uid desc");
        _MQ_noreturn("
        ...
        if($cash_a_no) {
            ...
            _MQ_noreturn("insert into odtOrderCashlog (ocs_ordernum,ocs_member,ocs_date,ocs_cashnum,ocs_amount,ocs_method,ocs_type) values ('$order_no','$ool_member',now(),'$cash_a_no','$ipgm_mnyx','AUTH','virtual')");
        }
