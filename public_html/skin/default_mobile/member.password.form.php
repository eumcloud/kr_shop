...
<div class="common_page">
    ...
    <div class="cm_member_password">            
            ...
            <div class="top_txt">
                <dl>
                    <dd>회원님의 소중한 개인정보를<br>안전하게 보호하기 위한</dd>
                    <dt>비밀번호 변경안내</dt>
                </dl>
            </div>      
            ...
            <div class="guide_txt">
                <ul>
                    ...
                    <li>비밀번호를 변경하실 경우, <strong>영문, 숫자로 6자이상</strong> 입력해 주세요.</li>
                </ul>
            </div>


            <div class="cm_member_form">
            <form name="c_pw" id="c_pw" action="/m/member.join.pro.php" target="common_frame" novalidate="novalidate" method="post">
            ...
            <div class="cm_bottom_button">
                <ul>
                    ...
                    <li><span class="button_pack"><a href="/m/?" title="비밀번호 다음에 변경하기" class="btn_lg_black">다음에 변경하기</a></span></li>
                </ul>
            </div>
            <!-- / 가운데정렬버튼 -->  
