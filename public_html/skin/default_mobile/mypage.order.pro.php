<?PHP
	...
	switch( $_mode ){
		...
		case "coupon_sms_resend":
			...
			// 주문상품과 쿠폰정보
			$osr = _MQ("select op_pname, op_option1, op_option2, op_option3, opc_expressnum, ordernum , userhtel1, userhtel2 , userhtel3,  orderhtel1, orderhtel2, orderhtel3 , opc_send
