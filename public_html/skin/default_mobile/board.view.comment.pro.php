<?PHP
	...
	switch( $_mode ){
		...
		case "view":
			...
			foreach( $btr as $k=>$v ){
				$del_button = ($v[bt_inid] == get_userid() && is_login()) ? "<a href='#none' onclick='bbs_talk_del(".$_buid." , ".$v[bt_uid].");return false;' class='btn_delete' title='댓글삭제'><span class='shape'></span></a>" : "";
				echo "
