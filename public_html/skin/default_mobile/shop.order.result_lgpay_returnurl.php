...
?>
<form method="post" name="LGD_PAYINFO" id="LGD_PAYINFO" action="/m/shop.order.result_lgpay.pro.php">
<?php
...
?>
<script>
alert("결제에 실패하였습니다. 다시 시도해주시기 바랍니다.");
top.location.href="/m/?pn=shop.order.result";
</script>
<?
  }
?>
