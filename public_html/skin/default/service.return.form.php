	...
	<div class="cm_board_form">
		<ul>
			...
			<li class="ess">
				...
				<div class="value">
					<style>
						#recaptcha_area a { display: inline !important; }
					</style>
					...
					var RecaptchaOptions = {
						...
						lang : 'ko',
						custom_translations : {
							instructions_visual : "문자를 입력하세요",
							instructions_audio : "소리를 듣고 입력하세요",
							play_again : "다시듣기",
							cant_hear_this : "MP3 파일로 듣기",
							visual_challenge : "문자를 입력하세요",
							audio_challenge : "소리를 듣고 입력하세요",
							refresh_btn : "새로고침",
							help_btn : "도움",
							incorrect_try_again : "다시 시도하세요.",
						},
					};
					</script>
					<?
					require_once(dirname(__FILE__).'/../../include/recaptcha/recaptchalib.php');
					$publickey = $row_setup['recaptcha_api']; // you got this from the signup page
	...
	<div class="cm_guest_order">
		<div class="inner_box">
			...
			<div class="search_form">
				...
				<input type="hidden" name="pn" value="<?=$pn?>"/>
				<div class="input_box">
					<input type="search" name="_ordernum" class="input_design" placeholder="주문번호" value=""  style="width:250px"/>
				</div>
