...
<div class="common_page common_none">
	...
	<div class="cm_common_top">
		<div class="commom_page_title">
			...
			<dl>
				<dt>로그인 정보찾기</dt>
				<dd>가입시 입력하셨던 정보로 아이디나 비밀번호를 찾으실 수 있습니다.</dd>
			</dl>
		</div>
	</div>
	<!-- / 타이틀상단 -->
	...
	<div class="cm_common_col_nav">
		<ul>
			<li><a href="/?pn=member.login.form" class="tab">로그인</a></li>
			<li><a href="/?pn=member.find.form" class="tab hit">로그인 정보찾기</a></li>
			<li><a href="/?pn=member.join.agree" class="tab">회원가입</a></li>
		</ul>
	</div>
	<!-- / 페이지메뉴 -->
...
<div class="common_page ">
	...
	<div class="cm_member_find">
		...
		<div class="left_box">
			...
			<!-- 아이디찾기 -->
			<div class="form">
				<div class="title_img"><strong>Find Id</strong> 아이디찾기</div>
		...
		<div class="right_box">
			...
			<!-- 비밀번호찾기 -->
			<div class="form">
				<div class="title_img"><strong>Find Password</strong>비밀번호찾기</div>
				...
				<ul>
					...
					<li><input type="text" name="find_pw_email" class="input_design" placeholder="이메일 주소"/></li>
				</ul>			
				<button type="submit" name="" class="btn_ok"/>Find</button>
				</form>
				...
				<div class="guide_text">
					<ul>
						<li>위사항을 입력하면 회원님의 이메일로 임시비밀번호를 보내드립니다.</li>
						<li>가입시 입력하셨던 정보를 모를 경우 고객센터로 문의해주십시오.</li>
					</ul>
				</div>
