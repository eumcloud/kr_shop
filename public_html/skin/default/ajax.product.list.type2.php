...
<div class="wide_item_box">
	...
	<div class="thumb">
		<? if( $coupon_chk ) { ?>
		<div class="upper_coup"><img src="/pages/images/coupon_list_upper.png" alt="쿠폰" /></div>
		<? } ?>
		<? if($row_setup['view_social_commerce']=='Y') { if($sale_percent>0) { ?>
		<div class="discount"><span class="num"><em><?=$sale_percent?></em>%</span></div>
		<? } else { ?>
		...
		<div class="img_box"><img src="<?=$image?>" alt="<?=$row['name']?>" /></div>
	</div>
	<!-- 한줄제한 -->
