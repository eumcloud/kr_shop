...
$returnUrl = "http://".$_SERVER[HTTP_HOST]."/pages/shop.order.result_billgate.pro.php";

if($r[paymethod]=='C') { $_method = 'credit'; } 
if($r[paymethod]=='L') { $_method = 'account'; } 
if($r[paymethod]=='V') { $_method = 'vaccount'; }

if($r[paymethod]!='C') { $returnUrl = "http://".$_SERVER[HTTP_HOST]."/pages/shop.order.result_billgate.pro.".$_method.".php"; }
