<?PHP
	...
	if($_GET['pcode'] && $_GET['pn'] == "product.view") {
		...
		if( $plr['cnt'] > 0 ) {
			_MQ_noreturn("delete from odtProductLatest where pl_pcode='".$pcode."' and pl_uniqkey='" . $appAuthSDProductLatest . "'");
		}
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ko" lang="ko" xmlns:og="http://ogp.me/ns#" xmlns:fb="http://www.facebook.com/2008/fbml">
	<head>
		...
		<? if(in_array($pn,array('shop.order.form','shop.order.result','shop.order.complete'))) { ?>
		...
		<script src="/pages/js/script.js?v=<?=$cache_ver?>" type="text/javascript"></script>

		<!-- 스타일시트 -->
		<link href="/pages/css/default_setting.css?v=<?=$cache_ver?>" rel="stylesheet" type="text/css" />
		<!-- 공통css -->
		<link href="/pages/css/cm_font.css?v=<?=$cache_ver?>" rel="stylesheet" type="text/css" />
		<link href="/pages/css/cm_design.css?v=<?=$cache_ver?>" rel="stylesheet" type="text/css" />
		<link href="/pages/css/cm_shop.css?v=<?=$cache_ver?>" rel="stylesheet" type="text/css" />
		<link href="/pages/css/cm_member.css?v=<?=$cache_ver?>" rel="stylesheet" type="text/css" />
		<link href="/pages/css/cm_board.css?v=<?=$cache_ver?>" rel="stylesheet" type="text/css" />
		<link href="/pages/css/cm_mypage.css?v=<?=$cache_ver?>" rel="stylesheet" type="text/css" />
		<!-- 수정css -->
		<link href="/pages/css/ticketmall.css?v=<?=$cache_ver?>" rel="stylesheet" type="text/css" />
		<link href="/pages/css/editor.css?v=<?=$cache_ver?>" rel="stylesheet" type="text/css" />
		<link href="/pages/css/part_cancel.css?v=<?=$cache_ver?>" rel="stylesheet" type="text/css" /><!-- 부분취소css -->
		<link href="/pages/css/customize.css?v=<?=$cache_ver?>" rel="stylesheet" type="text/css" />
		<link href="/pages/css/cm_customize.css?v=<?=$cache_ver?>" rel="stylesheet" type="text/css" />

		<? if($row_setup['view_social_commerce']!='Y') { ?>
		<link href="/pages/css/switch.css?v=<?=$cache_ver?>" rel="stylesheet" type="text/css" />
		<? } ?>
...
var obj = {method: 'feed',link: url, picture: 'http://<?=$_SERVER[HTTP_HOST]?>'+image,name: title,description: desc};
