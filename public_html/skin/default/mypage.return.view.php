...
if( $ordernum ) {
	...
	$ordr = _MQ_assoc("
		...
		where 1
			...
			and op.op_uid = '".$r['rr_opuid']."'
		group by op.op_pcode order by op_uid asc
	");
	//and op.op_cancel = 'N' and o.canceled = 'N' and o.order_type in ('both','product') and op.op_is_addoption = 'N' and op.op_delivstatus = 'Y'
	...
	<div class="cm_board_form">
		<ul>
			...
			<li class="ess">
				...
				<div class="value"><!-- 에디터 혹은 --><textarea readonly class="textarea_design"><?=strip_tags($r['rr_content'])?></textarea>
				</div>
			</li>
			<li class="ess double">
			...
			<li class="ess">
				...
				<div class="value"><!-- 에디터 혹은 --><textarea readonly class="textarea_design"><?=strip_tags($r['rr_admcontent'])?></textarea>
				</div>
			</li>
		</ul>
	</div><!-- .cm_board_form -->
