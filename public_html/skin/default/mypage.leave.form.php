...
<div class="layout_fix">
	...
	<div class="cm_mypage_leave">
		...
		<div class="form_box">
			<div class="title_img"><strong>Member Leave</strong> 회원탈퇴</div>
			<div class="sub_txt">그동안 저희 서비스를 이용하여 주셔서 대단히 감사합니다. <br/>
				더욱더 개선하여 좋은 서비스와 품질로 보답하겠습니다.<br/><br/>
			...
			<ul>
				...
				<li class="login_pw"><input type="password" name="fakepw" value="" style="display:none;"/><input type="password" name="leave_pw" id="leave_pw" class="input_design" placeholder="비밀번호" value=""/></li>
			</ul>			
			<input type="button" onclick="leave_submit();" name="" class="btn_leave" value="회원탈퇴"/>
		</div>
		</form>
