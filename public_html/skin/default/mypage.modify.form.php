	...
	<form name="join_frm" id="join_frm" method="post" action="/pages/member.join.pro.php" target="common_frame">
		...
		<div class="cm_member_form">
			<ul>
				...
				<!-- 비밀번호 변경일 과 비밀번호 변경알림 갱신을 추가  lcy -->
				<li class="ess double">
					<span class="opt">비밀번호 변경일</span>
					<div class="value"><?=rm_str($row_member[cpasswd])>0?date('Y-m-d',$row_member[cpasswd]):date('Y-m-d',$row_member[signdate])?>
						<div class="tip_txt">
							<dl>
								<dd>보안을 위해 비밀번호를 3개월마다 변경하시는게 좋습니다.</dd>
							</dl>
						</div>
					</div>
				</li>
				<li class="ess double">
					<span class="opt">변경알림 갱신일</span>
					<div class="value"><?=date('Y-m-d',$row_member[cpasswd_ck])?>
						<div class="tip_txt">
							<dl>
								<dd>비밀번호 변경알림 갱신일입니다.</dd>
							</dl>
						</div>
					</div>
				</li>
				<li class="ess double">
					...
					<div class="value">
						<input type="password" name="_passwd" id="_passwd" class="input_design" value=""/>
						<div class="tip_txt">
							<dl>
				...
				<li class="ess double">
					...
					<div class="value"><input type="password" name="_repasswd" id="_repasswd" class="input_design" value=""/>
						<div class="tip_txt">
							<dl>
				...
				<li class="double">
                    ...
                    <div class="value">
                        <?php if($row_setup['s_join_auth_use'] == 'Y') { // 2018-10-04 SSJ :: 본인인증 사용 시 ?>
                            <input type="text" name="_birth" class="input_design if_date js_auth_before auth_birth" id="" placeholder="(예:2015-05-01)" style="width:130px; margin-right:10px" value="<?=$birth?>" readonly/>
                        <?php } else { ?>
                            <input type="text" name="_birth" class="input_design" id="frm_request_birth" placeholder="(예:2015-05-01)" style="width:130px; margin-right:10px" value="<?=$birth?>" readonly/>
                        <?php } ?>
				...
				<li class="ess double">
                    ...
                    <div class="value">
                        <?php if($row_setup['s_join_auth_use'] == 'Y') { // 2018-10-04 SSJ :: 본인인증 사용 시 ?>
                            <input type="text" name="_htel" class="input_design js_auth_before auth_phone" maxlength="13" value="<?=phone_print($row_member['htel1'],$row_member['htel2'],$row_member['htel3'])?>" style="width:168px;" readonly/>
                        ...
                        <?php } else { ?>
                            <input type="text" name="_htel" class="input_design" maxlength="13" value="<?=phone_print($row_member['htel1'],$row_member['htel2'],$row_member['htel3'])?>"/>
                        <?php } ?>
                        <div class="tip_txt">
                            <dl>
				...
				<li class="ess double">
					...
					<div class="value">
						<input type="text" name="_email" class="input_design" placeholder="(아이디@주소)" value="<?=$row_member[email]?>"/>
						<div class="tip_txt">
							<dl>
				...
				<li>
					...
					<div class="value">
						...
						<span class="button_pack"><a href="#none" onclick="new_post_view();return false;" title="" class="btn_md_white">주소찾기</a></span>
						<div class="input_double">
							<div class="input_wrap"><div><input type="text" name="_address" id="_addr1" class="input_design" placeholder="기본주소" readonly value="<?=$row_member['address']?>"/></div></div>
							<div class="input_wrap"><div><input type="text" name="_address1" id="_addr2" class="input_design" placeholder="나머지 주소" value="<?=$row_member['address1']?>"/></div></div>
						</div>
						<!-- <div class="tip_txt">
							<dl>
				...
				<li class="double">
					...
					<div class="value">
					<input type="text" name="_tel" class="input_design" maxlength="13" value="<?=phone_print($row_member['tel1'],$row_member['tel2'],$row_member['tel3'])?>"/>
						<div class="tip_txt">
							<dl>
		...
		<div class="cm_bottom_button">
			<ul>
				<li><span class="button_pack"><a href="/?pn=mypage.main" title="" class="btn_lg_black">마이페이지메인</a></span></li>
...
<?php
    include_once $_SERVER[DOCUMENT_ROOT]."/newpost/newpost.search.php"; // 주소찾기 - 우편번호찾기 박스
