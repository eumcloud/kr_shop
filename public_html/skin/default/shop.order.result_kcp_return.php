...
<?
    ...
    if ( $tx_cd == "TX00" )
    {
        ...
        if($cash_a_no) {
            ...
            _MQ_noreturn("insert into odtOrderCashlog (ocs_ordernum,ocs_member,ocs_date,ocs_tid,ocs_cashnum,ocs_respdate,ocs_amount,ocs_method,ocs_type) values ('$order_no','$ool_member',now(),'$tno','$cash_a_no','$tx_tm','$ipgm_mnyx','AUTH','virtual')");
        }
