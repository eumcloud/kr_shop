...
<div class="cm_ly_pop_tp secret_ly_pop" style="width:550px;display:none;">
	<!--  레이어팝업 공통타이틀 영역 -->
	<div class="title_box">비밀글 열람하기<a href="#none" onclick="return false;" class="close btn_close" title="닫기"></a></div>
	<!-- 하얀색박스공간 -->
	<div class="inner_box">
		<!-- 설명글 -->
		<div class="top_txt">
			본 게시물을 열람하기 위해서는 비밀번호가 필요합니다.<br/><strong>글 등록 시 입력한 비밀번호를 입력해주세요</strong>
		</div>
