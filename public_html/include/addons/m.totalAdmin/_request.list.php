<?php
	...
	if( $mode == "search" ) {
		...
		// --- 검색 슬래시 풀기 ---
		$pass_title = stripslashes($pass_title);
		$pass_title_tmp = stripslashes($pass_title_tmp);
	}
...
<?php
	...
	foreach($res as $k=>$row){
		...
		$_mod = "<span class='button_pack'><a href='_request.form.php?pass_menu=" . $pass_menu . "&_mode=modify&_uid=". $row[r_uid] ."&_PVSC=" . $_PVSC . "' class='btn_sm_white'>수정</a></span>";
			...
			<dl>
				<dd>
					...
					<div class='request_info'>
						...
						<div class='title'>".strip_tags(stripslashes($row[r_title]))."</div>						
					</div>
				</dd>
				<dt>					
					<div class='btn_box'>
