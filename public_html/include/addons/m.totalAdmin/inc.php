<?php
	...
	// 경로정의
	define("PATH_MOBILE_TOTALADMIN",	"/include/addons/m.totalAdmin");	// 모바일 관리자 기본 PATH


	// 접속 메뉴 체크 - 상품목록 , 주문목록, 1:1문의
	$arr_menu_link = array( "/totalAdmin/_product.list.php" , "/totalAdmin/_order.list.php" , "/totalAdmin/_request.list.php?pass_menu=request");
