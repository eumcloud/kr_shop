...
/* m_sms_set 테이블 데이터 추가 */
$patch_arr['m_sms_set']['type'] = 'D';

/* odtSetup 테이블 칼럼추가 */
$patch_arr['odtSetup']['type'] = 'C';
$patch_arr['odtSetup']['list'] = array('s_set_email_txt','s_deny_tel','s_deny_use','s_2year_opt_use','s_2year_opt_title','s_2year_opt_content_top');

/* odtSetup 테이블 칼럼추가 */
$patch_arr['odtMailingData']['type'] = 'C';
$patch_arr['odtMailingData']['list'] = array('md_adchk');

/* odtSetup 테이블 칼럼추가 */
$patch_arr['odtMember']['type'] = 'C';
$patch_arr['odtMember']['list'] = array('m_opt_date');

/* odtSetup 테이블 칼럼추가 */
$patch_arr['odtMemberSleep']['type'] = 'C';
$patch_arr['odtMemberSleep']['list'] = array('m_opt_date');

/* odtMember080Deny  테이블 추가 */
$patch_arr['odtMember080Deny']['type'] = 'T';

/* odt2yearOptLog  테이블 추가 */
$patch_arr['odt2yearOptLog']['type'] = 'T';


?>
<form name='frm' method='post' action="/include/addons/action/_action.pro.php">
