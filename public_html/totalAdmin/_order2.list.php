<?PHP
// 페이지 표시
$app_current_link = "/totalAdmin/_order2.list.php?delivstatus=". $_REQUEST['delivstatus'] ."&ordertype=" . $_REQUEST['ordertype'] ;
...
<div class="form_box_area">
	<table class="form_TB" summary="검색항목">
		...
		<tbody>
			...
			<?php// LDD018 ?>
			<tr>
				<td class="article">예약발송 요청</td>
				<td class="conts" colspan="3">
					<a href="_order2.reserve_list.php"><?php echo number_format(reserve_order()); ?> 건</a>
					<?=_DescStr("예약발송 요청 항목은 <b>(배송)예약발송대기관리</b>에서 확인 바랍니다. ")?>
				</td>
			</tr>
			<?php// LDD018 ?>
		</tbody>
