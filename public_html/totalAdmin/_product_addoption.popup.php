...
<div class="new_option_box">
	...
	<!-- 상단 {-->
	<!-- 타이틀 {-->
	<div class="title_box">상품추가옵션 설정</div>
	<!--} 타이틀 -->
	...
	<div class="option_data_top">
		...
		<div class="guide_text"><span class="ic_blue"></span><span class="blue">공급가(추가), 판매가(추가) 항목은 입력 금액을 추가하는 방식으로 적용됩니다. <br/>판매가(추가) : 5,000원 일 경우 옵션 적용 시 5,000원이 적용됩니다. (상품 판매가는 포함되지 않습니다.)</span></div>
		<!--} 안내문구 -->
...
function option_excel_status(Action) {
	...
	if(!Action) Action = getCookie('add_option_excel_open');
	if(Action == 'open') Target.removeClass('if_open');
	else Target.removeClass('if_open').addClass('if_open');

	document.cookie = 'add_option_excel_open='+Action+';';
}
