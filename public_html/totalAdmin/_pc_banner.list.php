				...
				<div class="form_box_area">
					...
					<div class="top_btn_area">
						<div class="btn_line_up_center">
							...
							<?}?>
							<span class="shop_btn_pack"><span class="blank_3"></span></span>
							<span class="shop_btn_pack"><a href="_pc_banner.form.php?_loc=<?=$_loc?>&_mode=add" class="medium red" title="배너등록" >배너등록</a></span>
...
<?PHP
	...
	// 검색 체크
	$s_query = " where b_type='product_category' ";
	...
	$res = _MQ_assoc(" select * from odtBanner {$s_query} ORDER BY b_uid desc, b_edate desc limit $count , $listmaxcount ");
	...
	foreach($res as $k=>$v) {
		...
		$_mod = "<span class='shop_btn_pack'><input type=button value='수정' class='input_small white' onclick='location.href=(\"_pc_banner.form.php?_loc={$_loc}&_mode=modify&_uid=$v[b_uid]&_PVSC=${_PVSC}\");'></span>";
		$_del = "<span class='shop_btn_pack'><input type=button value='삭제' class='input_small gray'  onclick='del(\"_pc_banner.pro.php?_mode=delete&_uid=$v[b_uid]&_PVSC=${_PVSC}\");'></span>";
