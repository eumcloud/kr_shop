...
?>
							...
							<tr>
								<td class="conts" colspan="2">
									<?=_DescStr("매출금액뿐 아니라 발생된 업체 정산 금액 등을 업체별/기간별로 볼수있는 기능입니다.")?>
									...
									<?=_DescStr("수수료는 구매금액 - 입점업체 수수료로 계산되며 참조용입니다. <B>관리자업체에게 제공되는 비용</B>은 할인액을 제외한 <B>총 수수료</B>이므로 이를 참조하시기 바랍니다.")?>
									<?=_DescStr("<U>공급업체 검색 시 총 수수료를 확인할 수 없습니다.</U>")?>
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="list_TB" summary="리스트기본">
						<thead>
							<tr>
								...
								<th scope="col" class="colorset">공급업체</th>
		...
		foreach($res as $sk=>$sv){
			...
			echo "
				<tr height=30>
					...
					<td class='left'>". $arr_customer[$sv[op_partnerCode]] ."</td><!-- 공급업체 -->
