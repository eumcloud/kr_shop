				...
				<tr>
					...
					<td class="conts" >
						<?PHP
							...
							echo _InputSelect( "pass_company" , array_keys($arr_customer) , $pass_company , "" , array_values($arr_customer) , "전체");
						?>
					</td>
				</tr>
			</tbody> 
...
<div class="content_section_inner">
	<form name="OderAllDelete" method="post" target="common_frame">
		...
		<!-- 엑셀다운 {-->
		<div class="top_btn_area">
			<span class="shop_btn_pack"><a href="#none" onclick="saveExcel('_order4.excel.php');" id="saveexcel" class="small white" title="엑셀저장" >선택엑셀저장</a></span>
			<span class="shop_btn_pack"><span class="blank_3"></span></span>
			...
			<span class="shop_btn_pack"><span class="blank_3"></span></span>
			<span class="shop_btn_pack"><a href="#none" onclick="FormAction('_order4.pro.php')" id="cancel_settl" class="small red" title="선택 데이터를 정산대기 전환합니다.">정산대기 전환</a></span>
		</div>
		<!--} 엑셀다운 -->
		...
		<table class="list_TB" summary="리스트기본">
			...
			<tbody>
				<?php
				if(sizeof($res) <= 0) echo "<tr><td colspan='".($row_setup['TAX_CHK'] == 'Y'?'11':'10')."' height='100' style='text-align:center;'><font color='darkorange'>정산완료내역이 없습니다.</font></td></tr>";
				foreach($res as $k=>$v) {
				?>
				<tr>
					<td>
...
<script src="../include/js/jquery/jqueryui/jquery.ui.core.js"></script>
<script src="../include/js/jquery/jqueryui/jquery.ui.widget.js"></script>
<script src="../include/js/jquery/jqueryui/jquery.ui.datepicker.js"></script>
