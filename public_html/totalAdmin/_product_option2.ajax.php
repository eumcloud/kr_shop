...
switch($pass_mode) {
    ...
    case "1depth_del":
        ...
        // 삭제전 하위정보 확인
        $ique = " select count(*) from odtProductOption where oto_pcode='{$pass_code}' and find_in_set('{$pass_uid}' , oto_parent) > 0 and oto_depth <= '2' "; // 1차 정보
        ...
        // 삭제
        _MQ_noreturn("delete from odtProductOption where oto_uid='{$pass_uid}'");
    break;
            ...
            ?>
                ...
                <?php /* 2차 옵션 { */ ?>
                    ...
                    foreach($res2 as $k2=>$r2) {
                        if($r2['oto_poptionname'] == "" || !$r2['oto_poptionname']) $save_chk ++;
                    ?>
                    <li class="depth_2<?=$r2['oto_view'] == 'Y'?null:' if_option_hide';?>">
                        <!-- 순서항목 타이틀 -->
                        <div class="opt">
                        ...
                        <div class="value">
                            ...
                            <span class="wrapping_num">
                                ...
                                <input type="text" name="oto_info[<?=$r2['oto_uid']?>][oto_poptionpurprice]" class="input_design input_price" value="<?=$r2['oto_poptionpurprice']?>" placeholder="0" />
                            </span>
                            <span class="wrapping_num">                 
                                <span class="txt_box">판매가(추가)</span>
                                <input type="text" name="oto_info[<?=$r2['oto_uid']?>][oto_poptionprice]" class="input_design input_price" value="<?=$r2['oto_poptionprice']?>" placeholder="0" />
                            </span>
                            <span class="wrapping_num">
                                <span class="txt_box">수량(재고)</span>
                                <input type="text" name="oto_info[<?=$r2['oto_uid']?>][oto_cnt]" class="input_design input_number" value="<?=$r2['oto_cnt']?>" placeholder="0" />
                            </span>
                            <span class="wrapping_num">
                                <span class="txt_box">판매</span>
                                <input type="text" name="" class="input_design input_number" placeholder="0" readonly="readonly" value="<?=$r2['oto_salecnt']?>" disabled />
                            </span>
                            <!-- 순서변경 버튼 -->
                            <span class="btn_updown">
