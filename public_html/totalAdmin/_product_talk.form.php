<?PHP
	...
	// 페이지 표시
	$app_current_link = "/totalAdmin/_product_talk.list.php";
		...
		<table class="form_TB" summary="검색항목">
				...
				<tbody>
					...
					<tr>
						...
						<td class='conts'><?=$_ttName . "<br>(" .showUserInfo($ir['ttID']) . ")"?></td>
					</tr>
					<tr>
						<td class='article'>부모글내용</td>
						<td class='conts'><?=nl2br(stripslashes($ir['ttContent']))?></td>
					</tr>
				</tbody>
		</table>
	</div>
		...
		<table class="form_TB" summary="검색항목">
				...
				<tbody>
					<tr>
						...
						<td class="conts">
							<input type='hidden' name='ttID' class="input_text" value='<?=$ttID?>'/>
							<input type='text' name='ttName' class="input_text" value='<?=$ttName?>'/>
						</td>
					</tr>
					<tr>
