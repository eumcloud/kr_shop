...
//-->
    ...
    if ($rd == 0)
        SetCookie("LPINFO", "$a_id|$p_id|$l_id|$l_cd1|$l_cd2", 0, "/", str_replace("www" , "" , $_SERVER["HTTP_HOST"]));
    else
        SetCookie("LPINFO", "$a_id|$p_id|$l_id|$l_cd1|$l_cd2", time() + ($rd * 24 * 60 * 60), "/", str_replace("www" , "" , $_SERVER["HTTP_HOST"]));
